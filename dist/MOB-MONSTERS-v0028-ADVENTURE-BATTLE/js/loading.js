...
(()=>{
  ...
  let active=null,first=true,screenKey='',frame=0,suspended=false;
  window.MOBMON_LOADING={suspend(){suspended=true;cancel();},resume(){suspended=false;screenKey=screen.className;}};
