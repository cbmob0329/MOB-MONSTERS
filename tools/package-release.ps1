...
$releaseName = 'MOB-MONSTERS-v0024-LOADING-POPUP'
...
foreach ($name in @('smoke.js','ui_runtime_smoke.js','asset_contract.js','production_flow.cjs','production_edges.cjs','loading_modal.cjs','loading-results.json','browser-results.json','edge-results.json','screenshots')) {
